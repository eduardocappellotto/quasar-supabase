  ...
  <q-page padding>
    <q-form class="row justify-center" @submit.prevent="handleLogin">
      ...
      <div class="col-md-4 col-sm-6 col-xs-10 q-gutter-y-md">
        ...
        <q-input label="Password" v-model="form.password" type="password" lazy-rules
        ...
        <div class="full-width q-gutter-y-sm">
          ...
          <q-btn label="Forgot Password ?" color="primary" class="full-width" flat :to="{ name: 'forgot-password'}"
            size="sm" />
        </div>
      </div>
    </q-form>
